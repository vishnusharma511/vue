<template>
    <div class="profile-card">
        <form @submit.prevent="save">
            <p class="text-center">
                <img :src="user.avatar" :alt="`${user.name} profile photo`" class="avatar-xlarge img-update"/>
            </p>
            ...
            <div class="form-group">
                ...
                <input v-model="activeUser.website" class="form-input" id="user_website" autocomplete="off" />
            </div>

            <div class="form-group">
                <label class="form-label" for="user_email">Email</label>
                <input v-model="activeUser.email" class="form-input" id="user_email" autocomplete="off" />
            </div>

            <div class="form-group">
                <label class="form-label" for="user_location">Location</label>
                <input v-model="activeUser.location" class="form-input" id="user_location" autocomplete="off" />
            </div>
